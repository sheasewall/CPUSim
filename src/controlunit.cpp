...
void ControlUnit::decode() {
    p_current_instruction->decode(p_reg_file, p_igu);
}
...
std::shared_ptr<RISC::Instruction> ControlUnit::createInstruction(std::bitset<32> instruction)
{
    ...
    case 0b0110011: {
        ...
        if (funct3 == 0b000 && funct7 == 0b0000000) {
            ...
            throw std::runtime_error("Unknown R-type instruction: " + instruction.to_string());
        }
        break;
    }
    case 0b0010011: {
        ...
        if (funct3 == 0b000) {
            ...
            throw std::runtime_error("Unknown I-type instruction: " + instruction.to_string());
        }
        break;
    }
    case 0b0000011: {
    // IType (Load)
        if (funct3 == 0b010) {
            ...
            throw std::runtime_error("Unknown I-type load instruction: " + instruction.to_string());
        }
        break;
    }
    case 0b0100011: {
    // SType 
        if (funct3 == 0b000) {
            ...
            throw std::runtime_error("Unknown S-type instruction: " + instruction.to_string());
        }
        break;
    }
    case 0b1100011: {
    // BType
        if (funct3 == 0b000) {
            ...
            throw std::runtime_error("Unknown B-type instruction: " + instruction.to_string());
        }
        break;
    }
    case 0b0110111: {
