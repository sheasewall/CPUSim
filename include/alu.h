...
public:
     ...
     */
    static std::bitset<32> hardwareNor(std::bitset<32> val1, std::bitset<32> val2) { return ~(val1 | val2); }
     ...
     */
    static bool hardwareIsEqual(std::bitset<32> val1, std::bitset<32> val2) { return val1 == val2; }
     ...
     */
    static std::bitset<32> bitwiseNand(std::bitset<32> val1, std::bitset<32> val2);
     ...
     */
    static std::bitset<32> bitwiseXnor(std::bitset<32> val1, std::bitset<32> val2);
    ...
    static bool greaterThanEqualUnsigned(std::bitset<32> val1, std::bitset<32> val2);
    static bool greaterThanEqualSigned(std::bitset<32> val1, std::bitset<32> val2);
